...
namespace Xenia_Manager.Pages
{
    ...
    public partial class XeniaSettings : Page
    {
        ...
        private void LoadCountryComboBox()
        {
            ...
            {
                UserCountrySelector.Items.Add(country.Value);
            }
        }
                    ...
                    switch (section.Key)
                    {
                        ...
                        case "XConfig":
                            ...
                            if (sectionTable.ContainsKey("user_country"))
                            {
                                ...
                                {
                                    foreach (string item in UserCountrySelector.Items)
                                    {
                                        if (item == country)
                                        {
                                            UserCountrySelector.SelectedItem = item;
                                            break;
                                        }
                                    }
                                }
                ...
                foreach (var section in configFile)
                {
                    ...
                    switch (section.Key)
                    {
                        ...
                        case "XConfig":
                            ...
                            if (sectionTable.ContainsKey("user_country"))
                            {
                                if (countryIDMap.ContainsValue(UserCountrySelector.SelectedItem.ToString()))
                                {
                                    int? key = countryIDMap.FirstOrDefault(x => x.Value == UserCountrySelector.SelectedItem.ToString()).Key;
                                    ...
                                    {
                                        Log.Error("There was error while parsing the key from `user_country` setting");
