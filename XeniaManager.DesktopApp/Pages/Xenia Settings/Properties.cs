...
namespace XeniaManager.DesktopApp.Pages
{
    public partial class XeniaSettings
    {
        ...
        /// </summary>
        private readonly Dictionary<string, int> languageMap = new Dictionary<string, int>
        {
            { "English", 1 },
            { "Japanese/日本語", 2 },
            { "Deutsche", 3 },
        ...
        /// </summary>
        private readonly Dictionary<int, string> countryIdMap = new Dictionary<int, string>()
        {
