...
public class BindingsEntry
{
    ...
    public VirtualKeyCode? GetVirtualKeyCode() => BindingExtensions.ParseFromBindingString<VirtualKeyCode>(Key);

    /// <summary>
    /// Sets the keyboard key from a VirtualKeyCode enum value.
    /// </summary>
    /// <param name="keyCode">The virtual key code.</param>
    public void SetVirtualKeyCode(VirtualKeyCode keyCode) => Key = keyCode.ToBindingString();
    ...
    public XInputBinding? GetXInputBinding() => Value != null ? BindingExtensions.ParseFromBindingString<XInputBinding>(Value.ToString()!) : null;

    /// <summary>
    /// Sets the controller input from an XInputBinding enum value.
    /// </summary>
    /// <param name="binding">The XInput binding.</param>
    public void SetXInputBinding(XInputBinding binding) => Value = binding.ToBindingString();
}