...
public static class ConfigUiSettings
{
    ...
    /// </summary>
    private static ConfigUiDefinition ApuSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("APU")
                    ...
                    .AddToggle("mute", LocalizationHelper.GetText("ConfigUiSettings.APU.mute.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.APU.mute.Comment"))
                    .AddToggle("enable_xmp", LocalizationHelper.GetText("ConfigUiSettings.APU.enable_xmp.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.APU.enable_xmp.Comment"))
    ...
    /// </summary>
    private static ConfigUiDefinition ContentSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition CpuSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("CPU")
                    ...
                    .AddToggle("break_on_unimplemented_instructions",
                        LocalizationHelper.GetText("ConfigUiSettings.CPU.break_on_unimplemented_instructions.Title"),
    ...
    /// </summary>
    private static ConfigUiDefinition D3D12Settings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("D3D12")
                    ...
                    .AddToggle("d3d12_allow_variable_refresh_rate_and_tearing",
                        LocalizationHelper.GetText("ConfigUiSettings.D3D12.d3d12_allow_variable_refresh_rate_and_tearing.Title"),
    ...
    /// </summary>
    private static ConfigUiDefinition DisplaySettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("Display")
                    ...
                    .AddSlider("postprocess_ffx_fsr_sharpness_reduction", 0, 1, 0.01,
                        LocalizationHelper.GetText("ConfigUiSettings.Display.postprocess_ffx_fsr_sharpness_reduction.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.Display.postprocess_ffx_fsr_sharpness_reduction.Comment"), "F2")
                    .AddSlider("postprocess_ffx_cas_additional_sharpness", 0, 1, 0.01,
                        LocalizationHelper.GetText("ConfigUiSettings.Display.postprocess_ffx_cas_additional_sharpness.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.Display.postprocess_ffx_cas_additional_sharpness.Comment"), "F2")
                    .AddSlider("postprocess_ffx_fsr_max_upsampling_passes", 1, 4, 1,
                        LocalizationHelper.GetText("ConfigUiSettings.Display.postprocess_ffx_fsr_max_upsampling_passes.Title"),
    ...
    /// </summary>
    private static ConfigUiDefinition GeneralSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition GpuSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("GPU")
                    ...
                    .AddNumberBox("query_occlusion_sample_lower_threshold", -1, int.MaxValue,
                        LocalizationHelper.GetText("ConfigUiSettings.GPU.query_occlusion_sample_lower_threshold.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.GPU.query_occlusion_sample_lower_threshold.Comment"))
                    .AddNumberBox("query_occlusion_sample_upper_threshold", -1, int.MaxValue,
                        LocalizationHelper.GetText("ConfigUiSettings.GPU.query_occlusion_sample_upper_threshold.Title"),
    ...
    /// </summary>
    private static ConfigUiDefinition HidWinKeySettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition HidSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("HID")
                    ...
                    .AddComboBox("keyboard_mode", new Dictionary<object, string>
                        ...
                        }, LocalizationHelper.GetText("ConfigUiSettings.HID.keyboard_mode.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.HID.keyboard_mode.Comment"))
                    .AddSlider("keyboard_user_index", 0, 3, 1, LocalizationHelper.GetText("ConfigUiSettings.HID.keyboard_user_index.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.HID.keyboard_user_index.Comment"))
                    .AddSlider("left_stick_deadzone_percentage", 0, 1, 0.1,
                        LocalizationHelper.GetText("ConfigUiSettings.HID.left_stick_deadzone_percentage.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.HID.left_stick_deadzone_percentage.Comment"), "F1")
                    .AddSlider("right_stick_deadzone_percentage", 0, 1, 0.1,
                        LocalizationHelper.GetText("ConfigUiSettings.HID.right_stick_deadzone_percentage.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.HID.right_stick_deadzone_percentage.Comment"), "F1")
                    .AddToggle("vibration", LocalizationHelper.GetText("ConfigUiSettings.HID.vibration.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.HID.vibration.Comment"))
            )
            {
    ...
    /// </summary>
    private static ConfigUiDefinition KernelSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition LoggingSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition MemorySettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition StorageSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition UiSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition VideoSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("Video")
                    ...
                    .AddNumberBox("internal_display_resolution_x", 1, 1920,
                        LocalizationHelper.GetText("ConfigUiSettings.Video.internal_display_resolution_x.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.Video.internal_display_resolution_x.Comment"))
                    .AddNumberBox("internal_display_resolution_y", 1, 1080,
                        LocalizationHelper.GetText("ConfigUiSettings.Video.internal_display_resolution_y.Title"),
    ...
    /// </summary>
    private static ConfigUiDefinition VulkanSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("Vulkan")
                    ...
                    .AddToggle("vulkan_allow_present_mode_immediate",
                        LocalizationHelper.GetText("ConfigUiSettings.Vulkan.vulkan_allow_present_mode_immediate.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.Vulkan.vulkan_allow_present_mode_immediate.Comment"))
                    .AddToggle("vulkan_allow_present_mode_mailbox",
                        LocalizationHelper.GetText("ConfigUiSettings.Vulkan.vulkan_allow_present_mode_mailbox.Title"),
                        LocalizationHelper.GetText("ConfigUiSettings.Vulkan.vulkan_allow_present_mode_mailbox.Comment"))
                    .AddToggle("vulkan_allow_present_mode_fifo_relaxed",
                        LocalizationHelper.GetText("ConfigUiSettings.Vulkan.vulkan_allow_present_mode_fifo_relaxed.Title"),
    ...
    /// </summary>
    private static ConfigUiDefinition LiveSettings
    {
        get
        {
            return new ConfigUiDefinition(
    ...
    /// </summary>
    private static ConfigUiDefinition MouseHookSettings
    {
        get
        {
            return new ConfigUiDefinition(
                new ConfigSectionDefinition("MouseHook")
                    ...
                    .AddToggle("sr1_increase_vehicle_rotation_limit",
                        LocalizationHelper.GetText("ConfigUiSettings.MouseHook.sr1_increase_vehicle_rotation_limit.Title"),
